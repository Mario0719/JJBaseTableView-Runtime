...
/** 刷新回调 */
@property (nonatomic, copy) headerRefresh tableViewHeaderRefresh;
/** 加载回调 */
@property (nonatomic, copy) footerLoadMore tableViewFooterLoadMore;

/** 点击空数据 水印图 回调 */
@property (nonatomic, copy) clickPlaceholderBlock tableViewPlaceholderBlock;  //  e.g 重新加载数据、提示网络异常页面
